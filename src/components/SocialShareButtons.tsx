  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      ...
      <Button
        ...
        className="h-9 w-9 rounded-full bg-[#1877F2]/10 border-[#1877F2]/30 hover:bg-[#1877F2] hover:text-white hover:border-[#1877F2] transition-all"
      ...
      <Button
        ...
        className="h-9 w-9 rounded-full bg-foreground/5 border-foreground/20 hover:bg-foreground hover:text-background hover:border-foreground transition-all"
